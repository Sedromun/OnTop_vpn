...
from database.controllers.user import register_user
...
from text.texts import get_greeting_text, get_incorrect_command, get_information_text, get_profile_text, \
    get_buy_vpn_text
...
async def buy_handler(message: Message):
    await message.answer(text=get_buy_vpn_text(), reply_markup=get_buy_vpn_keyboard(extend=False))
...
async def profile_handler(message: Message):
    ...
    await message.answer(text=get_profile_text(id), reply_markup=get_profile_keyboard(id))
