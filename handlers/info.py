...
from text.info import get_countries_text, get_recalls_text, get_tech_support_text
...
async def info_countries_callback(
    ...
    await callback.message.edit_text(
        text=get_tech_support_text(), reply_markup=get_back_keyboard()
    )
    await callback.answer()
...
async def info_countries_callback(
    ...
    await callback.message.edit_text(
        text=get_recalls_text(), reply_markup=get_back_keyboard()
    )
    await callback.answer()
